...
def HideRunningIndicatorCss():
    return f"""<style>
        ...
        .loader-message {{
            ...
            font-family: {Configuration.FontFamily} !important; color: {Configuration.WhiteColor} !important; text-align: center; max-width: 420px;
        ...
        .loader-bar-track {{width: 320px; height: 8px; background: {Configuration.BackgroundAlpha}; border-radius: {Configuration.RadiusInput}px; overflow: hidden; margin-top: {Configuration.Spacing3}; box-shadow: inset 0 2px 8px rgba(0,0,0,0.1);}}
